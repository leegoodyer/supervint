...
const CLUSTERS = {
  outerwear: ['vinted-alerts-north-face', 'vinted-alerts-barbour', 'vinted-alerts-arcteryx', 'vinted-alerts-patagonia'],
  clothing: ['vinted-alerts-carhartt-workwear', 'vinted-alerts-football-shirts', 'vinted-alerts-stone-island', 'vinted-alerts-childrens-clothing'],
  footwear: ['vinted-adidas-trainers-alert', 'vinted-alerts-nike-trainers', 'vinted-alerts-dr-martens'],
  denim: ['vinted-alerts-vintage-denim', 'vinted-alerts-levis-denim'],
  accessories: ['vinted-alerts-designer-bags'],
  gaming: ['vinted-alerts-retro-gaming'],
  reselling: ['vinted-alerts-for-resellers', 'vinted-sniper', 'vinted-vs-depop-alerts', 'vinted-price-alert'],
  howItWorks: ['does-vinted-notify-price-changes', 'how-to-see-sold-prices-on-vinted'],
  safety: ['is-vinted-safe-to-sell-on', 'vinted-alerts-without-the-ban-risk'],
  help: ['how-to-contact-vinted-support', 'vinted-delivery-issues-troubleshooting', 'vinted-scams-buyer-protection', 'vinted-empty-box-scam', 'vinted-buyer-didnt-collect-order'],
};
