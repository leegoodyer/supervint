...
const CLUSTERS = {
  ...
  help: ['how-to-contact-vinted-support', 'vinted-delivery-issues-troubleshooting', 'vinted-inpost-qr-code-requires-label', 'vinted-scams-buyer-protection', 'vinted-empty-box-scam', 'vinted-buyer-didnt-collect-order', 'vinted-account-banned-email-scam', 'vinted-ai-banning-system', 'vinted-ai-damage-photo-scam'],
};
