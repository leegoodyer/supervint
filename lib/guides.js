...
const CLUSTERS = {
  outerwear: ['north-face-on-vinted', 'barbour-on-vinted', 'arcteryx-on-vinted', 'patagonia-on-vinted', 'fake-moncler-canada-goose-on-vinted'],
  clothing: ['carhartt-on-vinted', 'football-shirts-on-vinted', 'stone-island-on-vinted', 'kids-clothes-on-vinted', 'school-uniforms-on-vinted', 'halloween-costumes-on-vinted', 'ralph-lauren-on-vinted', 'lululemon-on-vinted'],
  footwear: ['adidas-on-vinted', 'nike-on-vinted', 'dr-martens-on-vinted', 'ugg-on-vinted'],
  denim: ['vintage-denim-on-vinted', 'levis-on-vinted'],
  accessories: ['designer-bags-on-vinted'],
  gaming: ['retro-games-on-vinted', 'lego-on-vinted', 'christmas-gifts-on-vinted', 'pokemon-cards-on-vinted'],
  ...
  help: ['how-to-contact-vinted-support', 'vinted-delivery-issues-troubleshooting', 'vinted-inpost-qr-code-requires-label', 'vinted-scams-buyer-protection', 'vinted-empty-box-scam', 'vinted-buyer-didnt-collect-order', 'vinted-account-banned-email-scam', 'vinted-ai-banning-system', 'vinted-ai-damage-photo-scam', 'vinted-item-verification-failed', 'vinted-id-verification-stuck-loop', 'vinted-buyer-pays-return-postage'],
};
