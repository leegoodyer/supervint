...
const CLUSTERS = {
  ...
  clothing: ['carhartt-on-vinted', 'football-shirts-on-vinted', 'stone-island-on-vinted', 'kids-clothes-on-vinted'],
  ...
  gaming: ['retro-games-on-vinted'],
  reselling: ['how-to-sell-on-vinted', 'how-to-get-more-views-on-vinted', 'reselling-on-vinted', 'vinted-sniper', 'vinted-vs-depop', 'vinted-vs-ebay', 'vinted-price-alert'],
  howItWorks: ['does-vinted-notify-price-changes', 'how-to-see-sold-prices-on-vinted'],
  safety: ['vinted-buyer-protection', 'is-vinted-safe-to-sell-on', 'vinted-ban-risk'],
